...
<body>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        <img src="{{ asset('layouts/backend/images/logo-sm.svg') }}" alt=""
                                                    ...
                                                    <div class="mt-4 pt-3 pb-5">
                                                        <div class="d-flex align-items-start">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{ asset('layouts/backend/images/users/avatar-1.jpg') }}"
                                            ...
                                            <div class="carousel-item">
                                                <div class="testi-contain text-white">
                                                    ...
                                                    <div class="mt-4 pt-3 pb-5">
                                                        <div class="d-flex align-items-start">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{ asset('layouts/backend/images/users/avatar-2.jpg') }}"
                                                                    class="avatar-md img-fluid rounded-circle"
                                                                    alt="...">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3 mb-4">
    ...
    <!-- password addon init -->
    <script src="{{ asset('layouts/backend/js/pages/pass-addon.init.js') }}"></script>
